...
_EXPLICIT_ENTRIES: dict[str, dict[str, Any]] = {
    ...
    "cloth apply-weightmap": _entry(
        ...
        "Apply a constant, vertex-color-derived, or root-bone-distance cloth max-distance weight map.",
        layer="bridge",
        category="cloth",
        requires_bridge=True,
        requires_editor=True,
        examples=["soft-ue-cli cloth apply-weightmap /Game/Characters/SK_Cape --asset-name CapeCloth --rule bone-distance --root-bone spine_03 --min-distance 0 --max-distance 80 --curve smooth --save"],
    ),
